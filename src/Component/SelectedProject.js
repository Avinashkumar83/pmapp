...
import Taska from "./Tasks";


function SelctedProject({project, onDelete,onAddTask,onDeleteTask,tasks}) {
    ...
    return ( 
        <div className="w-[35rem] mt-16">
          ...
          <Taska onAdd={onAddTask} onDelete={onDeleteTask} tasks={tasks}/>
        </div>
    )
}
export default SelctedProject;